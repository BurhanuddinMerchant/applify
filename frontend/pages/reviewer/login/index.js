...
export default function Login() {
  ...
  return (
    <>
      <Head>
        <title>Reviewer Login | Applify</title>
        <meta name="description" content="A Website to apply" />
          ...
          <div className=" mx-auto my-auto h-fit w-fit rounded-md bg-white p-10  shadow-lg sm:bg-slate-200">
            ...
            <form className=" flex flex-col " onSubmit={handleSubmit}>
              ...
              <input
                ...
                minLength={6}
                className="m-auto w-fit bg-white rounded-md border-2 border-gray-300 p-1 hover:border-blue-300 focus:border-blue-400 text-black"
                name="password"
                requiblue
                onChange={handleChange}
